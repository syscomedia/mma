      ...
      <section className="py-32 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
             <div>
                <p className="text-neon-green font-black uppercase tracking-[0.5em] text-[10px] mb-6">Notre Histoire</p>
                <h1 className="text-6xl md:text-8xl font-black text-medical-accent leading-none uppercase tracking-tighter mb-10">
                   L&apos;ESPRIT <br />
                   DE <span className="text-neon-green">SOIN.</span>
                </h1>
                <p className="text-medical-accent/50 font-bold text-xl leading-relaxed mb-12">
                   Fondée à Aix-en-Provence au début de l&apos;année 2025, la Maison Médicale Aixoise est née d&apos;une volonté 
                ...
                <div className="grid grid-cols-2 gap-8">
                   <div className="bg-white p-8 rounded-[2rem] border-2 border-black/5 shadow-xl">
                      <p className="text-4xl font-black text-neon-green mb-2 tracking-tighter">2025</p>
             ...
             <div className="relative">
                <div className="absolute -inset-10 bg-neon-green/10 rounded-full blur-3xl" />
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
              {[
                ...
                <div key={i} className="text-center group">
                   <div className="w-20 h-20 bg-white/5 rounded-3xl flex items-center justify-center mx-auto mb-10 group-hover:bg-neon-green transition-all shadow-2xl">
                      <val.icon className="text-neon-green group-hover:text-medical-accent" size={40} />
                   </div>
      ...
      <section className="py-32">
        <div className="max-w-4xl mx-auto px-6 text-center">
           <div className="bg-white p-16 rounded-[4rem] border-4 border-medical-accent/5 shadow-2xl relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-neon-green/5 rounded-bl-[5rem]" />
              <ShieldCheck className="text-neon-green mx-auto mb-10" size={64} />
