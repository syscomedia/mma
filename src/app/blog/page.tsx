...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Blog Santé & Orthopédie — Maison Médicale Aixoise",
    ...
    <main className="min-h-screen bg-sage-bg">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Blog",
            "name": "Blog Maison Médicale Aixoise",
      ...
      <div className="py-24 bg-medical-accent text-white text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6">
          <div className="inline-flex items-center gap-3 px-5 py-2 bg-white/5 border border-neon-green/30 rounded-full text-neon-green font-black text-[10px] uppercase tracking-[0.4em] mb-10">
            <BookOpen size={14} />
            Conseils d&apos;Experts
          </div>
          <h1 className="text-6xl md:text-8xl font-black uppercase tracking-tighter mb-6 leading-none">
            Santé & <span className="text-neon-green">Orthopédie</span>
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {articles.map((article) => (
            <Link key={article.slug} href={`/blog/${article.slug}`} className="group">
              <article className="bg-white rounded-[2.5rem] border-2 border-black/5 p-10 hover:border-neon-green transition-all shadow-xl h-full flex flex-col">
                ...
                <div className="flex items-center justify-between text-[10px] text-medical-accent/30 font-black uppercase tracking-widest">
                  ...
                  <div className="flex items-center gap-1 text-neon-green group-hover:gap-3 transition-all">
